...
exports.VisibilityExtender = void 0;
...
class VisibilityExtender {
    ...
    resetTimeout() {
        ...
        if (this.nextTimeoutAtMs === 0 || this.monitoring[0].extendAt < this.nextTimeoutAtMs) {
            ...
            clearTimeout(this.currentTimeout);
            (0, logger_1.log)('next extend is at', {
    ...
    extend() {
        ...
        for (let i = 0; i < this.monitoring.length; i++) {
            ...
            try {
                (0, logger_1.log)('extending message visibility', this.monitoring[i].msg);
                this.sqs.changeMessageVisibility(this.monitoring[i].msg, this.extendBySeconds);
            }
            catch (ex) {
                (0, logger_1.log)('failed to extend visibility', {
                    error: ex,
...
exports.VisibilityExtender = VisibilityExtender;
