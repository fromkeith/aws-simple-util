...
exports.EcsProtectionManager = void 0;
...
class EcsProtectionManager extends events_1.EventEmitter {
    /**
     * @constructor
     ...
     */
    constructor(desiredProtectionDurationInMins, maintainProtectionPercentage, refreshProtectionPercentage, protectionAdjustIntervalInMs) {
        super();
    ...
    async attemptAdjustProtection() {
        ...
        try {
            await (0, got_1.default)(`${process.env.ECS_AGENT_URI}/task-protection/v1/state`, {
                method: 'PUT',
                json: ecsAgentParams
            });
        }
...
exports.EcsProtectionManager = EcsProtectionManager;
